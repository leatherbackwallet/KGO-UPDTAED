 ...
 */
export const validateProductData = (productData: ProductData, isUpdate: boolean = false): ProductValidationResult => {
  const errors: string[] = [];
 ...
 */
export const validateCategoryIds = (categories: string[]): boolean => {
 ...
 */
export const validateImageFormat = (image: string): boolean => {
 ...
 */
export const validateComboItems = (comboItems: any[]): { isValid: boolean; errors: string[] } => {
  const errors: string[] = [];
