      ...
      <main className="min-h-screen">
        ...
        <section className="min-h-screen flex items-center justify-center relative pt-16">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              src="/images/products/Christmas Background.jpg"
          ...
          <div className="text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link 
                href="/products"
                className="px-8 py-4 text-lg font-semibold text-green-900 bg-white bg-opacity-20 backdrop-blur-md border border-white border-opacity-30 rounded-full hover:bg-opacity-30 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                Shop Now
              </Link>
              <Link 
                ...
                <div className="flex items-center justify-center space-x-4">
                  ...
                  <div className="text-center">
                    ...
                    <a 
                      ...
                      className="inline-flex items-center mt-3 px-6 py-2 bg-white bg-opacity-20 backdrop-blur-md text-white rounded-xl font-medium hover:bg-opacity-30 transition-all duration-300 border border-white border-opacity-30 shadow-lg"
                    >
