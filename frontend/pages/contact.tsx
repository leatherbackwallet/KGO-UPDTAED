...
export default function Contact() {
  return (
    <>
      <Head>
        <title>Contact Us - OnYourBehlf | Kerala Gifts Online</title>
        <meta name="description" content="Get in touch with OnYourBehlf - Your trusted source for authentic Kerala gifts and traditional products. Contact us for support, orders, or inquiries." />
        <meta name="keywords" content="contact, support, Kerala gifts, traditional products, customer service" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Multiple ways to reach us - we're always here to assist you
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg text-center border border-gray-200">
                ...
                <a 
                  href="mailto:sales@keralagiftsonline.com" 
                  className="text-kgo-red hover:text-red-700 font-semibold text-lg"
                >
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg text-center border border-gray-200">
                ...
                <p className="text-sm text-gray-500 mt-2">Available 9 AM - 6 PM IST</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg text-center border border-gray-200">
                ...
                <a 
                  href="https://instagram.com/keralagiftsonline" 
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <p className="text-sm text-gray-500 mt-2">Latest updates & products</p>
              </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">E-commerce Platform for Kerala Traditional Products</p>
                    </div>
                    <div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-600">You can track your order by logging into your account or contacting us with your order number.</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="space-y-6">
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-600">Standard delivery takes 24-48 hours within Kerala and 3-7 days for other locations in India.</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    <h4 className="font-semibold text-gray-900 mb-2">Can I customize my order?</h4>
                    <p className="text-gray-600">Yes, we offer personalized gift packages and custom orders. Contact us for special requirements.</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    <h4 className="font-semibold text-gray-900 mb-2">What if I'm not satisfied with my order?</h4>
                    <p className="text-gray-600">We offer a satisfaction guarantee. Please contact us within 48 hours of delivery for any issues.</p>
                  </div>
                </div>
              </div>
            </div>
