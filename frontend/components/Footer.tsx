...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-black bg-opacity-5 backdrop-blur-sm text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-800">WhatsApp: +91 8075030919</span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-blue-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-800">Email: sales@keralagiftsonline.com</span>
              </div>
              <div className="flex items-center">
                ...
                <a 
                  ...
                  className="text-gray-800 hover:text-purple-400 transition-colors"
                >
                  Instagram: @keralagiftsonline
                </a>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/content" className="text-gray-800 hover:text-gray-900 transition-colors">
                  Cultural Content
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/orders" className="text-gray-800 hover:text-gray-900 transition-colors">
                  My Orders
                </Link>
              </li>
              <li>
                <Link href="/wishlist" className="text-gray-800 hover:text-gray-900 transition-colors">
                  Wishlist
                </Link>
              </li>
              <li>
                <Link href="/cart" className="text-gray-800 hover:text-gray-900 transition-colors">
                  Shopping Cart
                </Link>
              </li>
              <li>
                <Link href="/profile" className="text-gray-800 hover:text-gray-900 transition-colors">
                  My Profile
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-end">
              ...
              <Link href="/refund" className="text-gray-600 hover:text-gray-800 text-sm transition-colors">
                Refund Policy
              </Link>
              <Link href="/shipping" className="text-gray-600 hover:text-gray-800 text-sm transition-colors">
                Shipping Policy
              </Link>
            </div>
          </div>
